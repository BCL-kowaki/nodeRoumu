...
export default function SettingsPage() {
  ...
  // 日付を表示用にフォーマット（YYYY-MM-DD → M/D(曜日)）
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* 特定休日管理 */}
      <Card>
        <div className="text-sm font-bold text-app-text mb-3">特定休日管理</div>
        <div className="text-[11px] text-app-sub mb-3">
        ...
        {/* 追加フォーム */}
        {showAddForm && (
          <div className="border border-app-border rounded-xl p-4 mb-4 bg-gray-50">
            <div className="mb-3">
        ...
        {holidaysLoading ? (
          ...
          <div className="flex flex-col gap-2">
            {closedDates.map((cd) => (
              <div
                key={cd.id}
                className="flex items-center justify-between bg-gray-50 border border-app-border rounded-lg px-3 py-2.5"
              >
